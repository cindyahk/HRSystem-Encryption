...
namespace MD5
{
    class MD5Prepare
    {
        ...
        public static String createAdditionalInfoFile(String fileUserName)
        {
            String additionalInfo = gen_randomString(16);
            String additionalInfoDir = @"D:\thesis programs\PUBLICATION\MD5\test\";
            String fileName = fileUserName+".txt";
            File.Create(fileName).Dispose();
            StreamWriter wr = new StreamWriter(additionalInfoDir + fileName);
            wr.WriteLine(additionalInfo);
            wr.Close();
            return additionalInfo;
        }

        public static String getAdditionalInfo(String userName)
        {
            String additionalInfoDir = @"D:\thesis programs\PUBLICATION\MD5\test\";
            String fileName = userName + ".txt";
            StreamReader reader = new StreamReader(additionalInfoDir + fileName);
